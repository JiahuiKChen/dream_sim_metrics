...
# ]
synth_img_dirs_0 = [f"{synth_img_root}dropout_90/", f"{synth_img_root}rand_img_cond_90/"]
synth_img_dirs_1 = [f"{synth_img_root}cutmix_90/", f"{synth_img_root}mixup_90/"]
synth_img_dirs_2 = [f"{synth_img_root}embed_cutmix_90/", f"{synth_img_root}embed_mixup_90/"]
synth_img_dirs_3 = [f"{synth_img_root}embed_cutmix_dropout_90/", f"{synth_img_root}embed_mixup_dropout_90/"]
synth_img_dirs_4 = [f"{synth_img_root}cutmix_dropout_90/", f"{synth_img_root}mixup_dropout_90/"]
